...
public class Prova {
    ...
    public static void main(String[] args) {
        ...
        SenyalTransit[] vecSenyals = new SenyalTransit[3];
     ...
     // Provem el mètode toString() de les senyals
        System.out.println("\n=== Provant del correcte funcionament del polimorfisme ===");
        vecSenyals[0] = advertencia1;
        vecSenyals[1] = reglamentacio1;
        vecSenyals[2] = indicacio1;
        
        for(int i = 0; i < 3; i++) {
            System.out.println(vecSenyals[i].toString());
        }
